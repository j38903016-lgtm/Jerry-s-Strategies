#!/usr/bin/env python3
"""A screenshot-style, read-only US-stock selection monitoring dashboard."""
...
SERVER_DB_PATH = Path("/data/us_stock_pipeline/us_stock_pipeline.sqlite3")
...
st.set_page_config(
    page_title="美股拐点预测看板 | US Stock Forecast Dashboard",
    page_icon="📈",
    layout="wide",
...
st.markdown(
    ...
    '<div class="hero-title">美股拐点预测看板</div>'
    '<div class="hero-title-en">US Stock Turning-Point Forecast Dashboard</div></div>'
    ...
    f'<div class="meta-item">生成时间 <strong>{generated_at}</strong><span class="en">Generated at · New York Time</span></div>'
