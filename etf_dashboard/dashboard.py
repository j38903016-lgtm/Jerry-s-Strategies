#!/usr/bin/env python3
"""A screenshot-style, read-only ETF-selection monitoring dashboard."""
...
SERVER_DB_PATH = Path("/data/a_share_etf_pipeline/a_share_etf_pipeline.sqlite3")
...
SYMBOL_NAMES = {
    "512480.SH": "半导体ETF国联安", "512880.SH": "证券ETF国泰",
    "512800.SH": "银行ETF华宝", "512660.SH": "军工ETF国泰",
    "512690.SH": "酒ETF鹏华", "512170.SH": "医疗ETF华宝",
    "515030.SH": "新能源车ETF华夏", "515790.SH": "光伏ETF华泰柏瑞",
    "516970.SH": "基建ETF广发", "512400.SH": "有色金属ETF南方",
    "512980.SH": "传媒ETF广发", "512580.SH": "环保ETF广发",
    "512200.SH": "房地产ETF南方", "512010.SH": "医药ETF易方达",
    "515050.SH": "通信ETF华夏", "515070.SH": "人工智能ETF华夏",
    "516510.SH": "云计算ETF易方达", "515400.SH": "大数据ETF富国",
    "512600.SH": "消费ETF嘉实", "515170.SH": "食品饮料ETF华夏",
    "515210.SH": "钢铁ETF国泰", "515220.SH": "煤炭ETF国泰",
    "516780.SH": "稀土ETF华泰柏瑞", "516960.SH": "机械ETF国泰",
    "515230.SH": "软件ETF国泰", "516020.SH": "化工ETF华宝",
    "516550.SH": "农业ETF嘉实", "159996.SZ": "家电ETF国泰",
    "159766.SZ": "旅游ETF富国", "159869.SZ": "游戏ETF华夏",
    "159865.SZ": "养殖ETF国泰", "159611.SZ": "电力ETF广发",
    "159745.SZ": "建材ETF国泰", "159770.SZ": "机器人ETF天弘",
}
...
st.set_page_config(
    page_title="A股ETF拐点预测看板 | A-Share ETF Forecast Dashboard",
    page_icon="📈",
    layout="wide",
...
st.markdown(
    ...
    '<div class="hero-title">A股ETF拐点预测看板</div>'
    '<div class="hero-title-en">A-Share ETF Turning-Point Forecast Dashboard</div></div>'
    ...
    f'<div class="meta-item">ETF数 <strong>{stock_count}</strong><span class="en">ETF Symbols</span></div>'
...
if published_run.empty:
    st.warning(
        "尚无覆盖完整ETF池的成功生产预测批次；当前仅展示历史测试结果。\n\n"
...
bilingual_note(
    "板块默认折叠；展开板块后查看该板块代表ETF，再展开ETF查看其买卖点预测图。",
    "Sectors are collapsed by default. Expand a sector to view its representative ETF and predicted turning points.",
)
if sector_df.empty:
    ...
    for _, sector_row in sector_df.iterrows():
        ...
        with st.expander(title, expanded=False):
            ...
            for _, stock_row in sector_models.iterrows():
                ...
                stock_title = (
                    f"`{symbol}` {SYMBOL_NAMES.get(symbol, '')}　│　{pct(stock_row['test_total_return'])}　│　{pct(stock_row['test_annual_return'])}　│　"
